...
impl<Auth: CodexAuthorization, Acc: CodexAccountId, U: IntoUrl> WhamSub for CodexClient<Auth, Acc, U> {}
#[cfg(feature = "middleware")]
impl<Auth: CodexAuthorization, Acc: CodexAccountId, U: IntoUrl> WhamSub for CodexMiddleware<Auth, Acc, U> {}
#[cfg(feature = "sync")]
...
#[cfg(feature = "sync")]
impl<Auth: CodexAuthorization, Acc: CodexAccountId, U: IntoUrl> WhamSync for blocking::CodexClient<Auth, Acc, U> {
